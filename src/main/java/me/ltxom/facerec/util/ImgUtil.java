...
public class ImgUtil {
   public static void generateRenderedImage() {


      WaterMaskImgUtils.pressText("img/checkData.jpg", "Xiangcai", "img/test.jpg", "宋体",
              Font.BOLD, 12, Color.RED, -1, -1, 1.0f, 0, "jpg");
      /**
       * 添加文字水印
       *
...
class WaterMaskImgUtils {
   ...
   public static void pressImage(String targetImg, String waterImg, int x, int y,
                                 float alpha, Integer degree, String suffix) {
    ...
    * @param degree    水印图片旋转角度
    */
   public static void pressImage(String targetImg, String waterImg, String outImg, int x,
                                 int y, float alpha, Integer degree, String suffix) {
      try {
   ...
   public static void pressText(String targetImg, String pressText, String fontName,
                                int fontStyle, int fontSize, Color color, int x, int y,
                                float alpha, String suffix) {
      pressText(targetImg, pressText, null, fontName, fontStyle, fontSize, color, x, y,
              alpha, null, suffix);
   }
    ...
    */
   public static void pressText(String targetImg, String pressText, String outImg,
    ...
    * @param alpha     透明度(0.0 -- 1.0, 0.0为完全透明，1.0为完全不透明)
    */
   public static void pressTextToRightBottom(String targetImg, String pressText,
                                             String fontName, int fontStyle, int fontSize,
                                             Color color, float alpha, String suffix) {

      pressTextToRightBottom(targetImg, pressText, null, fontName, fontStyle, fontSize,
              color, alpha, null, suffix);
   }
    ...
    */
   public static void pressTextToRightBottom(String targetImg, String pressText,
                                             String outImg, String fontName, int fontStyle,
                                             int fontSize, Color color, float alpha,
                                             Integer degree, String suffix) {
      try {
         File file = new File(targetImg);
         File outFile;
         if (StringUtils.isEmpty(outImg)) {
